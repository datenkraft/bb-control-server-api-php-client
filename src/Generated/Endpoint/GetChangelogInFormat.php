...
class GetChangelogInFormat extends \Datenkraft\Backbone\Client\ControlServerApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\ControlServerApi\Generated\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (404 === $status) {
            throw new \Datenkraft\Backbone\Client\ControlServerApi\Generated\Exception\GetChangelogInFormatNotFoundException($response);
        }
        if (400 === $status) {
            throw new \Datenkraft\Backbone\Client\ControlServerApi\Generated\Exception\GetChangelogInFormatBadRequestException($response);
        }
